...
const WorkingRegisterPage = () => {
  ...
  const generateStellarKeys = () => {
    ...
    toast.success('Carteira Stellar criada! Preencha seus dados abaixo.')
  }
        ...
        <div className="space-y-6">
          ...
          {!formData.publicKey && (
            <div className="bg-dark-800/50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Criar Carteira Stellar</h3>
              <p className="text-dark-400 mb-4">
                Clique no botão abaixo para criar uma carteira Stellar simulada
              </p>
              <Button
...
export default WorkingRegisterPage
