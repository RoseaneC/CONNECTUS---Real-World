...
async function testUserRegistration() {
  try {
    const userData = {
      ...
      age: 24, // Adicionando campo age que estava faltando
    ...
    logTest('User Registration', false, errorMessage);
    return false;
  }
}
...
async function testUserLogin() {
  try {
    ...
    logTest('User Login', false, errorMessage);
    return false;
  }
}
...
async function testPostsTimeline() {
  try {
    ...
    logTest('Posts Timeline', false, errorMessage);
    return false;
  }
}
...
async function testMissions() {
  try {
    ...
    logTest('Missions System', false, errorMessage);
    return false;
  }
}
...
async function testChat() {
  try {
    ...
    logTest('Chat System', false, errorMessage);
    return false;
  }
}
...
async function testRanking() {
  try {
    ...
    logTest('Ranking System', false, errorMessage);
    return false;
  }
}
...
async function testUserProfile() {
  try {
    ...
    logTest('User Profile', false, errorMessage);
    return false;
  }
}
