...
async def get_current_user_info(current_user: User = Depends(get_current_active_user)):
    ...
    return UserProfile(
        ...
        tokens_earned=float(current_user.tokens_earned or 0.0),
        tokens_available=float(current_user.tokens_available or 0.0),
        tokens_in_yield=float(current_user.tokens_in_yield or 0.0),
        missions_completed=current_user.missions_completed or 0,
        posts_created=current_user.posts_created or 0,
        likes_received=current_user.likes_received or 0,
        comments_made=current_user.comments_made or 0,
