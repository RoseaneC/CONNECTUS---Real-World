#!/usr/bin/env python3
"""
Servidor de autenticação Connectus com SQLite (PORTA 8001)
"""
...
async def health_check():
    ...
    return {"status": "ok", "message": "Connectus API funcionando na porta 8001"}
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Iniciando servidor Connectus (PORTA 8001)...")
