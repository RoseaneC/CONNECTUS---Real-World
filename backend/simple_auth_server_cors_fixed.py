#!/usr/bin/env python3
"""
Servidor de autenticação Connectus com CORS corrigido
"""
...
async def health_check():
    ...
    return {"status": "ok", "message": "Connectus API funcionando com CORS corrigido"}
...
async def verify_token(request: Request):
    ...
    return {"valid": True, "user_id": user[0]}

if __name__ == "__main__":
    import uvicorn
    print("🚀 Iniciando servidor Connectus (CORS CORRIGIDO)...")
